...
reset-files: does [
	...
	; TODO: Remove if you can figure out reactions.
	file-listing/data: files/filtered-files
]
...
mod-selector: layout [
	title {Mod Selector}
	across
	search-bar: field white 300x24 on-change [search-files]
	...
	file-listing: text-list white 334x500 data files/filtered-files
